const questions = {
    ...
    'Cybersecurity': {
        'easy': [
            ...
            { question: "MFA means...", answers: ["A. Multi-Factor Authentication", "B. My Fabulous Antivirus", "C. Main Firewall Alert"], correctIndex: 0 },
    ...
    'Internet Usage': {
        'easy': [
            ...
            { question: "What is HTTP mainly used for?", answers: ["A. Transferring files between servers", "B. Exchanging hypermedia documents", "C. Sending emails"], correctIndex: 1 },
            { question: "What is the function of a search engine?", answers: ["A. Find information on the web", "B. Block viruses", "C. Filter spam"], correctIndex: 0 }
        ],
        'intermediate': [
